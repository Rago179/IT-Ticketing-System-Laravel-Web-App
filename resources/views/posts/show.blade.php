    ...
    <div class="container">
        ...
        <div style="margin-top: 10px; margin-bottom: 20px;">
            @foreach($post->categories as $category)
                <span style="background: #e2e8f0; color: #475569; padding: 4px 10px; border-radius: 12px; font-size: 0.85em; margin-right: 5px; font-weight: 500;">
                    {{ $category->name }}
                </span>
            @endforeach
        </div>
        ...
        <div class="post-content">
            {{-- Use nl2br to make line breaks appear --}}
        ...
        <div class="comments-section">
            ...
            @foreach($post->comments as $comment)
                <div class="comment">
                    ...
                    {{-- Use nl2br for comments as well --}}
